...
const UserIcon = () => (
  ...
  >
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <circle cx="16.5" cy="10.5" r="0.5" fill="#7B68EE" />
    <circle cx="17.5" cy="4.5" r="0.5" fill="#7B68EE" />
    <circle cx="5.5" cy="14.5" r="0.5" fill="#7B68EE" />
    <circle cx="3.5" cy="18.5" r="0.5" fill="#7B68EE" />
    <circle cx="10.5" cy="15.5" r="0.5" fill="#7B68EE" />
    <circle cx="7" cy="17.5" r="0.5" fill="#7B68EE" />
    <circle cx="11.5" cy="20.5" r="0.5" fill="#7B68EE" />
    <circle cx="20.5" cy="8.5" r="0.5" fill="#7B68EE" />
  </svg>
);
