    ...
    <div className="survey-container">
      ...
      {step === 2 && (
        <div className="survey-step">
            ...
            <div className="button-group"> {/* ✅ 버튼 그룹 추가 */}
      ...
      {step === 5 && (
        <div className="survey-step">
          ...
          <div className="button-group">
          {["4시간 이하", "5~6시간", "7~8시간", "9시간 이상"].map((option) => (
            <button key={option} onClick={() => selectAndNext("sleepHours", option)}>
              {option}
            </button>
          ))}
        </div></div>
      ...
      {step === 6 && (
        <div className="survey-step">
          ...
          <div className="button-group">
          {["활동적인 일을 하고 있어요", "주로 앉아서 일해요", "현재는 쉬고 있어요"].map(
            (option) => (
              <button key={option} onClick={() => selectAndNext("activityLevel", option)}>
                {option}
              </button>
            )
          )}
      ...
      {step === 7 && (
        <div className="survey-step">
          ...
          <button onClick={() => selectAndNext("exercise", "아니오")}>아니오</button>
        </div></div>
      )}
